...
#print("The Max of Temperature in the Top loop is: ", meanfirstcol)

#pl.hist(firstcol)                   # When import matplotlib.pyplot is used, we can plot data. In this case, a histogram

#pl.show()                           # This requests to show the plot
