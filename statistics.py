...
with open(filename, "w", newline='') as f:
    ...
    writer.writerow(["Scatter", scatsetseplen, scatsetsepwid, scatsetpetlen, scatsetpetwid, "Setosa"])
    ...
    writer.writerow(["Scatter", scatverseplen, scatversepwid, scatverpetlen, scatverpetwid, "Versicolor"])
    ...
    writer.writerow(["Scatter", scatvirseplen, scatvirsepwid, scatvirpetlen, scatvirpetwid, "Virgninica"])
    writer.writerow(["Average", meanvirseplen, meanvirsepwid, meanvirpetlen, meanvirpetwid, "Virgninica"])
