...
In order to compare and contrast each specie, please see [Comparison_of_Iris_species_for_individual_attributes.png](/Images/Comparison_of_Iris_species_for_individual_attributes.png) These plots were produced by running summary.py and the resulting plots saved to the images folder in this directory. From these plots, we can make a number of observations:
