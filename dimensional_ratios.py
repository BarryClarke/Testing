...
with open(filename, "w", newline='') as f:
    ...
    writer = csv.writer(f)
    writer.writerow(["", "", "length/width ratios", "", ""])
    # Write a header now
    ...
    writer.writerow(["", "Std Dev", format(stdsetsep, '.3f'), format(stdversep,'.3f'), format(stdvirsep, '.3f')])
    writer.writerow(["Petal", "Average", format(meansetpet, '.3f'), format(meanverpet, '.3f'), format(meanvirpet, '.3f')])
    writer.writerow(["", "Std Dev", format(stdsetpet, '.3f'), format(stdverpet,'.3f'), format(stdvirpet, '.3f')])
    writer.writerow([])   
